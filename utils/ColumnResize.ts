...
export interface ColumnWidthOptions
    extends Partial<
            Pick<
                ColumnWidthState,
                "width" | "maxWidth" | "minWidth" | "padding"
            >
        >,
...
export class ColumnResize {
    ...
    constructor(
        columns: ColumnWidthOptions[],
        onColumnWidthsUpdate: () => void
    ) {
    ...
    public resetLayout() {
        ...
        while (
            ...
            availableWidth > this.columns[i].minWidth + this.columns[i].padding
        ) {
        ...
        while (
            i < this.columns.length &&
            availableWidth > this.columns[i].idealWidth
        ) {
            const column = this.columns[i];
